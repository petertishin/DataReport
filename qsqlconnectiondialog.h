...
/*
    QDomElement database(QDomDocument& domDoc,
...
//    void writeInXml(QString db);
    ...
    bool createNewDatabase() const;

private slots:
    void on_okButton_clicked();
    void on_cancelButton_clicked() { reject(); }
    void on_dbCheckBox_clicked() { ui.connGroupBox->setEnabled(!ui.dbCheckBox->isChecked());
                                   ui.newdbCheckBox->setEnabled(!ui.dbCheckBox->isChecked()); }
    void on_newdbCheckBox_clicked() { ui.dbCheckBox->setEnabled(!ui.newdbCheckBox->isChecked()); }
